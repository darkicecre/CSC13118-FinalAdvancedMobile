...
import 'package:final_advanced_mobile/screens/ReUse/NavigationMenu.dart';
...
class MyAppBar extends StatelessWidget implements PreferredSizeWidget{
  ...
  Widget build(BuildContext context) {
    ...
    final svgPath = setting.lang == "English" ? "assets/images/usa_flag.svg" : "assets/images/vn_flag.svg";
          ...
          child: ElevatedButton(
            onPressed: () {
              if(setting.lang=="English"){
                setting.changeLanguage("Vietnamese");
              }
              else{
                setting.changeLanguage("English");
              }
            },
            child: Container(
              child:
              SvgPicture.asset(svgPath, height: 26),
